...
public class ExpandableListFragment extends Fragment {
    ...
    final private ExpandableListView.OnChildClickListener mOnClickListener
            = new ExpandableListView.OnChildClickListener() {
        public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
            return ExpandableListFragment.this.onChildClick((ExpandableListView)parent, v, groupPosition, childPosition, id);
        }
    };
    ...
    /**
     * Get the ListAdapter associated with this activity's ExpandableListView.
     */
    ...
    private void ensureList() {
        ...
        mListShown = true;
        mList.setOnChildClickListener(mOnClickListener);
        if (mAdapter != null) {
